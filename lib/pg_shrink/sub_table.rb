module PgShrink
  class SubTable
    attr_accessor :parent, :table_name, :data_source
    ...
    def initialize(parent, table_name, data_source, opts = {})
      self.parent = parent
    ...
    def propagate_filters(parent_data_old, parent_data_new)
      ...
      self.table.data_source.update_records(original_records, new_records)
    end
